...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://fakeql.com/graphql/ba7960a1fda1208d1e0848e1aa39c7ab", {
    method: "POST",
...
export type CommentsQuery = { __typename?: 'Query', comments?: Array<{ __typename?: 'Comment', id: string, text: string, user: { __typename?: 'User', id: string, firstname: string } } | null | undefined> | null | undefined };
